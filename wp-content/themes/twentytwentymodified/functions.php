...
function theme_name_scripts() {
	wp_enqueue_style( 'subs_styles', get_template_directory_uri().'/subs_styles.css' );
	wp_enqueue_script( 'subs_js', get_template_directory_uri() . '/js/subs.js', NULL, '1.0.0', true );
}
